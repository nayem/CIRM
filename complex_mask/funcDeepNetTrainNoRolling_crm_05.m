function [model, pre_net, cv_rec] = funcDeepNetTrainNoRolling_crm_05(train_feats,train_label_real, train_label_imag,train_weights,dev_feats,dev_label_real,dev_label_imag,dev_weights, opts)
