function scriptTrainDNN_cIRM_denoise_41(noise)
...
for noise_ind = 1:length(noise)
    ...
    elseif strcmp(test_noise,'Cafe') == 1
        cs_training_data_path      = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/training_16k/');
        training_mix_wav_save_path = strcat(path_data_directory,'/denoising_mix_wavs_Cafe_15000noisespercs/training_16k/');

    elseif strcmp(test_noise,'Babble') == 1
        cs_training_data_path      = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/training_16k/');
        training_mix_wav_save_path = strcat(path_data_directory,'/denoising_mix_wavs_Babble_15000noisespercs/training_16k/');

    elseif strcmp(test_noise,'Factory') == 1
        cs_training_data_path      = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/training_16k/');
        training_mix_wav_save_path = strcat(path_data_directory,'/denoising_mix_wavs_Factory_15000noisespercs/training_16k/');
    end

    fprintf('Extracting Features/Labels from Training Data...\n')
    STATS_FILE = strcat(path_data_directory,'/dnn_models/Train_datas_spec.mat');
    %[trData, trLabel_r, trLabel_i, opts, trNumframes] = prepareTrainingData_cIRM_denoise41(STATS_FILE,globalpara,cs_training_data_path,training_mix_wav_save_path);
    [~, ~, ~, opts, trNumframes] = prepareTrainingData_cIRM_denoise41(STATS_FILE,globalpara,cs_training_data_path,training_mix_wav_save_path);
    ...
    elseif strcmp(test_noise,'Cafe') == 1
        cs_dev_data_path      = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/development_16k/');
        noisy_dev_data_path   = strcat(path_data_directory,'/denoising_mix_wavs_Cafe_15000noisespercs/development_16k/');

    elseif strcmp(test_noise,'Babble') == 1
        cs_dev_data_path      = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/development_16k/');
        noisy_dev_data_path   = strcat(path_data_directory,'/denoising_mix_wavs_Babble_15000noisespercs/development_16k/');

    elseif strcmp(test_noise,'Factory') == 1
        cs_dev_data_path      = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/development_16k/');
        noisy_dev_data_path   = strcat(path_data_directory,'/denoising_mix_wavs_Factory_15000noisespercs/development_16k/');
    end

    fprintf('Extracting Features/Labels from Development Data...\n')
    STATS_FILE = strcat(path_data_directory,'/dnn_models/CrossValidation_datas_spec.mat');
    %[cvData, cvLabel_r, cvLabel_i, opts, cvNumframes]  = prepareDevData_cIRM_denoise41(STATS_FILE,globalpara,cs_dev_data_path,noisy_dev_data_path);
    [~, ~, ~, opts, cvNumframes]  = prepareDevData_cIRM_denoise41(STATS_FILE,globalpara,cs_dev_data_path,noisy_dev_data_path);
    ...
    elseif strcmp(test_noise,'Cafe') == 1
        cs_testing_data_path       = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/testing_16k/');
        testing_mix_wav_save_path  = strcat(path_data_directory,'/denoising_mix_wavs_Cafe_15000noisespercs/testing_matched/');

    elseif strcmp(test_noise,'Babble') == 1
        cs_testing_data_path       = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/testing_16k/');
        testing_mix_wav_save_path  = strcat(path_data_directory,'/denoising_mix_wavs_Babble_15000noisespercs/testing_matched/');

    elseif strcmp(test_noise,'Factory') == 1
        cs_testing_data_path       = strcat(path_data_directory,'/denoising_clean_wavs_SSN_10noisespercs/testing_16k/');
        testing_mix_wav_save_path  = strcat(path_data_directory,'/denoising_mix_wavs_Factory_15000noisespercs/testing_matched/');
    end

    fprintf('Extracting Features/Labels from Testing Data...\n')
    STATS_FILE = strcat(path_data_directory,'/dnn_models/Test_datas_spec.mat');
    %[teData, teLabel_r, teLabel_i, opts, teNumframes]  = prepareTestingData_cIRM_denoise41(STATS_FILE,globalpara,cs_testing_data_path,testing_mix_wav_save_path);
    [~, ~, ~, opts, teNumframes]  = prepareTestingData_cIRM_denoise41(STATS_FILE,globalpara,cs_testing_data_path,testing_mix_wav_save_path);
