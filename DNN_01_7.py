...
DNN_NET_FILE = "./dnn_models/DNN_net_07.mat"
...
biases = {
    'b1': bias_variable([1, n_hidden_1]),
    'b2': bias_variable([1, n_hidden_2]),
    'b3': bias_variable([1, n_hidden_3]),
    'out': bias_variable([1, n_classes])
}
...
def calc(x, y):
    ...
    return [predictions, mse_r, mse_i, loss_d ]
