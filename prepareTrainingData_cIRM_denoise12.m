function [trData, trLabel_r,trLabel_i, para, numframes] = prepareTrainingData_cIRM_denoise12(globalpara,cs_training_data_path,training_mix_wav_save_path)
...
trFilename  = strings(sum(numframes),1);
