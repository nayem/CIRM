function [pesq_mos]= pesq_mat(ref_wav, deg_wav)
...
if nargin<2
    fprintf('Usage: [pesq_mos]=pesq_mat(cleanfile.mat,enhanced.mat) \n');
    return;
end;
