function [cost, net_gradients] = computeNetGradient_mixphone(theta, data, label1, label2, opts)
net = netRolling_mixphone(theta, opts.net_struct);
...
%%
net_gradients = netUnRolling_mixphone(net_gradients);