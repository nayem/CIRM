function scriptTestDNN_cIRM_denoise_mat()
...
for noise_ind = 1:length(noise_types)
    ...
    net_file = sprintf('./dnn_models/BR2_dnncirm.noise%s.mat',noise_types{noise_ind});
%     net_file = sprintf('./dnn_models/DNN_CIRM_net.mat');

    testing_clean_wav_save_path       = sprintf('/gpfs/home/k/n/knayem/BigRed2/Eagles_Backup/Data/denoising_clean_mats_SSN_10noisespercs/testing_16k/',noise_types{noise_ind});
    testing_matched_mix_wav_save_path = sprintf('/gpfs/home/k/n/knayem/BigRed2/Eagles_Backup/Data/denoising_mix_mats_SSN_10noisespercs/testing_matched/',noise_types{noise_ind});
...
%     testing_matched_mix_wav_save_path = sprintf('./denoising_mix_wavs_%s_10noisespercs/testing_matched/',noise_types{noise_ind});
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    files     = dir(fullfile(testing_matched_mix_wav_save_path,'*.mat'));
    ...
    for fileNum = 1:length(files)
        ...
        snrNum           = str(4:end);
        %
        clean_files     = dir(fullfile(testing_clean_wav_save_path,'*.mat'));
        CLEAN_FILENAME = '';
