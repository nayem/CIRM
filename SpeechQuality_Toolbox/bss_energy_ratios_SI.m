function [varargout]=bss_energy_ratios_SI(F_s_target,F_e_interf,varargin)
...
switch nargin
    case 3
        ...
        % SI-SAR
        varargout{4}= 10*log10( sum(F_s_target.^2,2)./sum(F_e_artif.^2,2) ); % edited
    ...
    case 4        
        ...
        % SI-SAR
        varargout{5}= 10*log10( sum(F_s_target.^2,2)./sum(F_e_artif.^2,2) ); % edited
end