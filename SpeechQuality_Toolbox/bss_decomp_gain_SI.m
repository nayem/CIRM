function varargout=bss_decomp_gain_SI(varargin)
...
switch nargin
    case 3
        [varargout{1},varargout{2},varargout{3}]=bss_decomp_filt_SI(varargin{1},varargin{2},varargin{3},varargin{4},0);
    case 4
        [varargout{1},varargout{2},varargout{3},varargout{4}]=bss_decomp_filt_SI(varargin{1},varargin{2},varargin{3},varargin{4},varargin{5},0);
    otherwise
